...
APiccvoiceAA = \relative c'{
    ...
    ais8 e4( g?8) ais( b) c( des) g,( e)      | % 44
    ...
    R1*5/4 *12  | % 
        | % 88
    \times 2/3{f8( \f \< ^\markup {\upright  "ritard"} fis g)  } \times 2/3{f( fis g)  } \times 2/3{f( fis g)  } \times 2/3{f g aes  } \times 2/3{f aes bes  }  \bar "||"    | % 89
    %bartimesig: 
    \time 4/4 
...
AClvoiceFA = \relative c'{
    ...
    R1*5/4 *2  | % 
    g4( f fes) \times 2/3{g8( fes ees)  } \times 2/3{g( e c)  }      | % 82
    R1*5/4  | % 
    g4( b ees) \times 2/3{g,8( ces fes)  } \times 2/3{g,( c g')  }      | % 84
    R1*5/4 *4  | % 
        | % 88
...
ABsnvoiceHA = \relative c{
    ...
    d d,4 d d d8      | % 150
    d' d,4 d d d8     | % 151
    c8( \< \p d) e( d) e( fis) g( fis) _\markup {\upright  "attacca"} \! \bar "|." 
}% end of last bar in partorvoice
...
ACbsnvoiceJA = \relative c{
    ...
    d d d r      | % 150
    d,1      | % 151
    c4 \< \p c c' c _\markup {\upright  "attacca"} \! \bar "|." 
}% end of last bar in partorvoice
...
AHnvoiceLA = \relative c{
    ...
    R1 *26  | % 
         | % 151
    g,8( \< \p a) b( a) b( cis) d( cis) _\markup {\upright  "attacca"} \! \bar "|." 
}% end of last bar in partorvoice
...
AHnvoiceMA = \relative c'{
    ...
    \times 2/3{c8( e gis)  } \times 2/3{c,( f bes)  } c,4( fis c')      | % 79
    R1*5/4 *2  | % 
    c4( b bes) \times 2/3{c8( bes aes)  } \times 2/3{c( a fis)  }      | % 82
    R1*5/4  | % 
    c4( e gis) \times 2/3{c,8( f bes)  } \times 2/3{c,( fis c')  }      | % 84
    R1*5/4 *4  | % 
         | % 88
    r1 c,4 \ff \bar "||"     | % 89
    %bartimesig: 
...
AVlnvoiceVA = \relative c'{
    ...
    r2 d4-.  ^\markup {\italic "pizzicato"}  \mf r aes,-.       | % 28
    r2 bes'4-.  r g,-.       | % 29
    r2 c'4-.  \mp r fis,,-.       | % 30
    r2 aes'4-.  r f,-.       | % 31
    r2 bes'4-.  r e,,-.       | % 32
...
AVlnvoiceWA = \relative c'{
    ...
    g fis f \times 2/3{g8 f ees  } \times 2/3{g e des  }      | % 26
    g,4 b ees \times 2/3{g,8 c f  } \times 2/3{g, des' g  }      | % 27
    r2 d'4-.  ^\markup {\italic "pizzicato"}  \mf r aes,-.       | % 28
    r2 bes'4-.  r g,-.       | % 29
    r2 c'4-.  \mp r fis,,-.       | % 30
    r2 aes'4-.  r f,-.       | % 31
    r2 bes'4-.  r e,,-.       | % 32
...
AVlavoiceXA = \relative c'{
    ...
    R1 *15  | % 
    r2 r4 r8 d, \p         | % 151
    c8( \< d) e( d) e( fis) g( fis) _\markup {\upright  "attacca"} \! \bar "|." 
}% end of last bar in partorvoice
...
AVlcvoiceYA = \relative c{
    ...
    aes1~ aes4      | % 26
    c des d( ees e)      | % 27
    d-\mf ^\markup {\italic "pizzicato"} d'-.  r2 r4      | % 28
    d,-.  c'-.  r2 r4      | % 29
    d,-.  bes'-.  r2 r4      | % 30
    d,-.  aes'-.  r2 r4      | % 31
    d,-.  fis-.  r2 r4      | % 32
...
ACbvoiceZA = \relative c{
    ...
    d1~ d4      | % 26
    d1~ d4      | % 27
    d'- \mf ^\markup {\italic "pizzicato"}  r r2 r4      | % 28
    d-.  r r2 r4      | % 29
    d-.  r r2 r4      | % 30
    d-.  r r2 r4      | % 31
    d-.  r r2 r4      | % 32
    d-.  r r2 r4      | % 33
    R1*5/4 *6  | % 
    d,4 \< ^\markup {\upright  "arco"} \mf d-- ( d-- ) \times 2/3{d8-.  d-.  d-.   } \times 2/3{d-.  d-.  d-.   }      | % 40
    ...
    des      | % 108
    des2 r      | % 109
    des ^\markup {\italic "pizzicato"}  des      | % 110
    des des      | % 111
    des des      | % 112
    des des      | % 113
    des des      | % 114
    ...
    R1 *10  | % 
    d1      | % 151
    c4 \< c c c _\markup {\upright  "attacca"} \! \bar "|." 
}% end of last bar in partorvoice
