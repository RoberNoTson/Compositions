...
AvoiceAA = \relative c'{
    ...
    r4 r16 d( \upbow ^\markup {\italic  "arco"} \mf b c bes) f( a ees gis a) r fis( \upbow      | % 43
    ...
    c4 ^\markup {\italic  "pizz."} \grace{\stemUp f8( } \stemNeutral e4)\downbow ^\markup {\italic  "arco"} \trill r8 fis( \upbow a8. f16)      | % 53
    ...
    r16 gis( \< \upbow b c g'4) \flageolet g8 \mf \downbow a,16( g') bes,8 r      | % 59
    g'8.( \downbow b,16) g'8 r g16( \< c, g' cis,) g'4      | % 60
    ...
    a'8.( f16) f8.( aes,16-.) c( ees,) f'( a, b'8-.) d,-- \downbow      | % 69
    fis( \upbow a,~) a r g4 ^\markup {\upright  "pizz."} \p g'      | % 70
